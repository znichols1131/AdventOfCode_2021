...
namespace _2021AdventChallenges
{
    class MainProgram
    {
        static void Main(string[] args)
        {
            ...
            // Challenge 07
            //(new Challenge_07()).Challenge_A();
            //(new Challenge_07()).Challenge_B();

            // Challenge 08
            //(new Challenge_08()).Challenge_A();
            //(new Challenge_08()).Challenge_B();

            // Challenge 09
            //(new Challenge_09()).Challenge_A();
            //(new Challenge_09()).Challenge_B();

            // Challenge 10
            //(new Challenge_10()).Challenge_A();
            //(new Challenge_10()).Challenge_B();

            // Challenge 11
            //(new Challenge_11()).Challenge_A();
            //(new Challenge_11()).Challenge_B();

            // Challenge 12
            //(new Challenge_12()).Challenge_A();
            //(new Challenge_12()).Challenge_B();
            ...
            //(new Challenge_16()).Challenge_B();

            // Challenge 17
            //(new Challenge_17()).Challenge_A();
            //(new Challenge_17()).Challenge_B();
            ...
            //(new Challenge_20()).Challenge_B();

            // Challenge 21
            //(new Challenge_21()).Challenge_A();
            //(new Challenge_21()).Challenge_B();

            // Challenge 22
            //(new Challenge_22()).Challenge_A();
            //(new Challenge_22()).Challenge_B();

            // Challenge 23
            //(new Challenge_23()).Challenge_A();
            //(new Challenge_23()).Challenge_B();

            // Challenge 24
            //(new Challenge_24()).Challenge_A();
